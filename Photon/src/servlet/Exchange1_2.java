...
import Start_View.Start1_2;

/**
 * Servlet implementation class Exchange1_2
 */
@WebServlet("/Exchange1_2")
public class Exchange1_2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Start1_2 start=new Start1_2(Order);
