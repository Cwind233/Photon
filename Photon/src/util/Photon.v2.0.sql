...
insert  into `login`(`userName`,`password`) values ('098','098'),('123','123'),('123456','123456'),('2','3'),('213','213123'),('321','321'),('345','345'),('456789','e35cf7b66449df565f93c607d5a81d09'),('876','876'),('987','987');
...
insert  into `personalinformation`(`userName`,`nickName`,`email`,`headImage`) values ('098','test','test','test'),('123','123','123','123'),('123456','test','test','test'),('2','test','test','test'),('213','test','test','test'),('321','321','321','321'),('345','test','test','test'),('456789','test','test','test'),('876','test','test','test'),('987','test','test','test');
